...
# Define the function
def sushi():
    label_id["text"] = "SWAZZY2110"
    label_name["text"] = "Swaz"
    label_dob["text"] = "21/10/2008"
    label_pin["text"] = "7351934"
    label_address["text"] = "Paris, America"
    label_vehicle_type["text"] = "Ferrari"
    
    
# Create a button
button1 = Button(root, text = "Press this", command = sushi)
button1.pack()
